...
function SectionThree() {
  return (
    ...
    <div className='mt-[5rem]'>
         <h1 className=' text-[#4D5053] text-center mx-6 md:mx-24 '> What the People Thinks About Us </h1>
    </div>
            ...
            return (
                 <div key={index} className=" bg-white  rounded-3xl   p-5">
                    <div className='flex gap-4  mt-[1rem] '>
                        ...
                        <div >
                            <h6 className=' text-[#292F36] font-bold'>{name}</h6>
                            <p className='text-[ #4D5053]'>{country}</p>
                        </div>
                    </div>
                    <p className='mt-5 text-[ #4D5053]'>{description}</p>
                </div>
            )
        })}
        </div>
