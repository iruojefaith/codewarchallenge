...
function Contact() {
  return (
    ...
    <div className='text-center  '>
        <h1 className=' text-[#fff]'>Wanna join the interno?</h1>
        <p className='md:text-lg text-[#fff] py-7 '>It is a long established fact  will be distracted.</p>
    </div>

        <button className=" mt-[-6rem] ml-[1rem] bg-[#CDA274] p-4 rounded-[.8rem] text-[#FFF] flex ">Contact With Us &nbsp;&nbsp;<AiOutlineArrowRight className='text-[#4D5053] mt-[.4rem] '/></button>
