          ...
          />
           <div className='  grid h-screen place-items-center '>
            <div className='absolute -mt-[7rem] justify-center align-middle '>
              <h3 className='text-[55px] md:text-[50px] leading-8 my-6 bg-[#fff] px-16 md:px-24 py-10 w-50 rounded-tr-3xl rounded-tl-3xl text-center'>Services <br></br><span className='text-[20px] leading-1 '>Home/Services</span> </h3>
                 </div>
            </div>
    </div>

        <div className=' grid grid-cols-1  md:grid-cols-3  place-items-middle md:mx-[15rem]  mx-1rem  -my-52'>
