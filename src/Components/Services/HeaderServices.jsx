          ...
          />
           <div className='  grid h-screen place-items-center '>
            <div className='absolute -mt-[7rem] justify-center align-middle '>
              <h3 className=' md:text-[50px] leading-8 my-6 bg-[#fff] px-16 md:px-24 py-10 w-50 rounded-tr-3xl rounded-tl-3xl text-center'>Services <br></br><span className='text-[20px] leading-1 '>Home/Services</span> </h3>
                 </div>
            </div>
    </div>
        ...
        return (
            <div className='flex  gap-2  m-3 h-30 justify-center align-middle '>
             <div key={index} className=" w-full  p-2 flex  flex-col text-center justify-items-center items-center "  >
                 <h3 className='t  font-bold '>{title}</h3>
